...
const Payment = () => {
  ...
  const [address, setAddress] = useState(userAddress || {
    ...
    zip: '20100',
    mapImg: 'https://maps.googleapis.com/maps/api/staticmap?center=Barcelona,Spain&zoom=14&size=123x114&maptype=roadmap&markers=color:red%7Clabel:A%7CBarcelona,Spain&key=AIzaSyB4UPFEGdKm-2iC9EVODGRR43j9pIYGbaA',
  });
        ...
        autocomplete.addListener('place_changed', () => {
          ...
          if (place.formatted_address) {
            ...
            if (place.geometry && place.geometry.location) {
              ...
              mapImg = `https://maps.googleapis.com/maps/api/staticmap?center=${lat},${lng}&zoom=15&size=123x114&maptype=roadmap&markers=color:red%7Clabel:A%7C${lat},${lng}&key=AIzaSyB4UPFEGdKm-2iC9EVODGRR43j9pIYGbaA`;
            }
